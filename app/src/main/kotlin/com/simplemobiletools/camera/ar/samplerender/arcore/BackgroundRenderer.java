 ...
 */
package com.simplemobiletools.camera.ar.samplerender.arcore;
...
public class BackgroundRenderer {
	 ...
	 * during a {@link SampleRender.Renderer} callback.
	 */
	public BackgroundRenderer(SampleRender render) {
		cameraColorTexture = new Texture(render, Texture.Target.TEXTURE_EXTERNAL_OES, Texture.WrapMode.CLAMP_TO_EDGE, /*useMipmaps=*/false);
		cameraDepthTexture = new Texture(render, Texture.Target.TEXTURE_2D, Texture.WrapMode.CLAMP_TO_EDGE, /*useMipmaps=*/false);
	 ...
	 *
	 * @param frame The current {@code Frame} as returned by the Session update.
	 */
